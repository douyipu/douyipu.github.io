...
![职位类型](assets/img/shanghai-ai-position-distribution.png)
...
![alt text](assets/img/chain-open-source-system.png)
...
![opendatalab.org.cn](assets/img/OpenDataLab.png)

下载榜单：

![榜单](assets/img/Download-leaderboard.png)

数据库示例：

![WanJuan2.0（WanJuan-CC）](assets/img/wanjuan-cc.png)
...
![alt text](assets/img/compasshub.png)

#### CompassRank 评测榜单

CompassRank 提供了由 OpenCompass 评测体系的排名结果，分为**大语言模型**和**多模态模型**。

![alt text](assets/img/compassrank.png)
